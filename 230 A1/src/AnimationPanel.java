...
public class AnimationPanel extends JComponent implements Runnable {
    ...
    public AnimationPanel() {
		...
		addMouseListener( new MouseAdapter() {
            ...
            public void mouseClicked( MouseEvent e ) {
            	//The mouseClicked method is called if the user presses a mouse 
            	//button and then releases it, without moving the mouse. 
    ...
    protected void createNewShape(int x, int y) {
        ...
        switch (currentShapeType) {
        	case 0: shape = new MovingRectangle(x, y, currentWidth, 
                    currentHeight, marginWidth, marginHeight, currentBorderColor, 
                    currentFillColor, currentPathType); // x and y are mouse coord
            		break;
            		
        	case 1: shape = new MovingOval(x, y, currentWidth, 
                    currentHeight, marginWidth, marginHeight, currentBorderColor, 
                    currentFillColor, currentPathType); // x and y are mouse coord
            		break;
            		
        	case 2: shape = new MovingChecker(x, y, currentWidth, 
                    currentHeight, marginWidth, marginHeight, currentBorderColor, 
                    currentFillColor, currentPathType); // x and y are mouse coord
            		break;
            		
        	case 3: shape = new MovingGradient(x, y, currentWidth, 
                    currentHeight, marginWidth, marginHeight, currentBorderColor, 
                    currentFillColor, currentPathType); // x and y are mouse coord
            		break;
            		
        	case 4: shape = new MovingShapePattern(x, y, currentWidth, 
                    currentHeight, marginWidth, marginHeight, currentBorderColor, 
                    currentFillColor, currentPathType); // x and y are mouse coord
            		break;
        }
