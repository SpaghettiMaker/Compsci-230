...
public abstract class MovingShape {
     ...
     * draw the shape
     * @param currentShape     the Graphics control
     */
    ...
    public class FallingPath extends MovingPath {
        ...
        /** constructor to initialize values for a falling path
        */
        public FallingPath() {
    ...
    public class SideWaysPath extends MovingPath {
       ...
       */
       public void move() {
           ...
           if (topLeft.x > marginWidth) // if it reaches the side of the frame, start again from the side
               topLeft.x = 0;
       }
    }
}
